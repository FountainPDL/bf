...
/**
 * A single unit voxel cube.
 * Attribute names MUST match the flat shader in GameRenderer and OperatorRenderer:
 *   attribute vec4 vPos      (was: vPosition)
 *   attribute vec4 vCol      (was: vColor)
 *   uniform   mat4 uMVP      (was: uMVPMatrix)
 */
public class VoxelCube {
    ...
    public void draw(int program, float[] mvpMatrix, float[] color) {
        // ── Attribute names MUST match the flat shader: vPos, vCol, uMVP ──
